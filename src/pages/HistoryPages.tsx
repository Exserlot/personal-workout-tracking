...
function ExerciseEditor({ exercise, exerciseOptions, onChange, onDelete, onMove, canDelete, editing, error }: { exercise: SessionExercise; exerciseOptions: Exercise[]; onChange: (next: SessionExercise) => void; onDelete: () => void; onMove: (direction: -1 | 1) => void; canDelete: boolean; editing: boolean; error?: string }) {
