...
const week = {
  ...
  days: [
    { id: "push", routine_day_id: "routine-push", template_id: "template-push", display_order: 1, day_label: "Push", template_name: "Push", completed_count: 2 },
    { id: "pull", routine_day_id: "routine-pull", template_id: "template-pull", display_order: 2, day_label: "Pull", template_name: "Pull", completed_count: 0 },
    { id: "legs", routine_day_id: "routine-legs", template_id: "template-legs", display_order: 3, day_label: "Legs", template_name: "Legs", completed_count: 1 },
  ],
};
