  ...
  return <PageFrame pageId="P-11" eyebrow="P-11 · PROGRESS" title="ความก้าวหน้า" description="แนวโน้มและสถิติจาก Completed Working Sets ที่ซิงก์แล้ว">
    ...
    <div className="page-grid">
      <div className="col-span-4 grid grid-cols-2 gap-x-4 tablet:col-span-8 tablet:grid-cols-4 desktop:col-span-12">
        <StatBlock label="PR · 30 DAYS" value={String(overview.stats.recentPrCount)} unit="PR" accent />
        <StatBlock label="SESSIONS · 30 DAYS" value={String(overview.stats.recentSessionCount)} />
        <StatBlock label="VOLUME · 30 DAYS" value={formatProgressVolume(overview.stats.recentVolumeKg, unit)} />
        <StatBlock label="EXERCISES TRACKED" value={String(overview.stats.trackedExerciseCount)} />
      </div>
      ...
      <section className="col-span-4 mt-12 border-t border-line pt-6 tablet:col-span-8 desktop:col-span-12"><SectionHeader eyebrow="EXERCISE PROGRESS" title="ทุกท่าที่ติดตาม" description="เรียงจากท่าที่ฝึกล่าสุด" />
